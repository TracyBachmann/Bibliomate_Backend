...
namespace backend.Services
{
    ...
    public interface IHistoryService
    {
        ...
        /// <param name="eventType">Type or name of the event (e.g. "Loan", "Return").</param>
        /// <param name="loanId">Optional associated loan identifier.</param>
        /// <param name="reservationId">Optional associated reservation identifier.</param>
        Task LogEventAsync(int userId, string eventType, int? loanId = null, int? reservationId = null);
        ...
        Task<List<HistoryReadDto>> GetHistoryForUserAsync(int userId, int page = 1, int pageSize = 20);
    }
}